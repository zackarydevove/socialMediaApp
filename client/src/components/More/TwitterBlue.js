...
function TwitterBlue({setOpenTwitterBlue}) {
  ...
  return (
    <div className='z-40 fixed left-0 top-0 md:w-screen md:h-screen bg-blue-300 bg-opacity-20'>
        <div className='w-screen h-screen md:w-[600px] md:h-[750px] md:fixed md:left-[50%] md:translate-x-[-50%] md:top-16 z-30 bg-black opacity- md:rounded-2xl'>
            <div className='flex flex-col w-full h-full z-40 relative'>
                ...
                {/* Mid calls */}
                <div className='pl-20 flex-grow flex flex-col max-md:gap-5 justify-center items-start'>
                    <div className='flex justify-start items-center pr-20 gap-5'>
